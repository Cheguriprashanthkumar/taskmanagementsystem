...
public class SwaggerConfig {
    ...
    public OpenAPI springShopOpenAPI() {
        return new OpenAPI()
                ...
                .externalDocs(new ExternalDocumentation()
                        ...
                        .url("github.com/prashanth/task-management-system"));
    }
    ...
    private Contact newContact() {
        ...
        contact.setName("prashanth");
        contact.setUrl("https://www.github.com/prashanth");
        contact.setEmail("prashanthkumarcheguru@gmail.com");
        return contact;
    }
}
